...
import com.restaurant.server.service.AdminCategoryService;
...
public class AdminCategoryController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<Page<ContentDtos.CategoryView>>> list(
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<ContentDtos.CategoryView>> create(
            @Valid @RequestBody AdminDtos.CategoryRequest req,
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<ContentDtos.CategoryView>> update(
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<ContentDtos.CategoryView>> patch(
            @PathVariable Long id,
            @RequestBody AdminDtos.CategoryPatchRequest req,
            @AuthenticationPrincipal JwtAuthFilter.AuthenticatedUser principal) {
